...
#include "human_feature_detection_cpp/point_cloud_processor.hpp"
...
class HUMAN_FEATURE_DETECT_3D {
    private:
        ...
        rclcpp::Service<sobits_interfaces::srv::Feature3d>::SharedPtr server_feature_3d;
        // ros::NodeHandle nh_;
        // ros::NodeHandle pnh_;
        // ros::Subscriber sub_points_;
        // ros::Publisher pub_cloud_;
        std::string topic_name;
        human_feature_detection_cpp::PointCloudProcessor pcp_;
        ...
        void human_feature_3d(const std::shared_ptr<sobits_interfaces::srv::Feature3d::Request> req, std::shared_ptr<sobits_interfaces::srv::Feature3d::Response> res)
        ...
        void wait_for_call()
        {
            server_feature_3d = nd_->create_service<sobits_interfaces::srv::Feature3d>("/human_feature_detection_cpp/feature3d", std::bind(&HUMAN_FEATURE_DETECT_3D::human_feature_3d, this, std::placeholders::_1, std::placeholders::_2));
